...
const sanitizeRoom = (room) => ({
    id: room.id,
    userId: room.user_id,
    userName: room.first_name && room.last_name ? `${room.first_name} ${room.last_name}` : null,
    userEmail: room.email,
    companyId: room.company_id,
    companyName: room.company_name,
    assignedAdminId: room.assigned_admin_id,
    assignedAdminName:
        room.admin_first_name && room.admin_last_name
            ? `${room.admin_first_name} ${room.admin_last_name}`
            : null,
    status: room.status,
...
const sanitizeMessage = (msg) => ({
    ...
    senderName: msg.first_name && msg.last_name ? `${msg.first_name} ${msg.last_name}` : null,
