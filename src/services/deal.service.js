...
const dealAttachmentRepository = require('../repositories/dealAttachment.repository');
const dealRequestDetailsRepository = require('../repositories/dealRequestDetails.repository');
