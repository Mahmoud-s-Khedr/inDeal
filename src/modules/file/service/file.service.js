...
const { s3Client, bucket, publicUrl } = require('../../../infrastructure/config/storage');
const {
  MAX_FILE_SIZE_BYTES,
  SIGNED_URL_TTL_SECONDS,
} = require('../../../shared/constants/storage');
const { enqueueImageOptimization } = require('../../../infrastructure/config/jobQueue');
