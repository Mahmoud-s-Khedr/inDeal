...
const updateCompanyGalleryItem = catchAsync(async (req, res) => {
  const item = await adminCompanyService.updateCompanyGalleryItem(
    req.params.id,
...
const deleteCompanyGalleryItem = catchAsync(async (req, res) => {
  const item = await adminCompanyService.deleteCompanyGalleryItem(
    req.params.id,
    req.params.galleryItemId
  );
...
const updateCompanyDocument = catchAsync(async (req, res) => {
  const doc = await adminCompanyService.updateCompanyDocument(
    req.params.id,
...
const deleteCompanyContribution = catchAsync(async (req, res) => {
  const item = await adminCompanyService.deleteCompanyContribution(
    req.params.id,
    req.params.contributionId
  );
