...
export async function runAdminFlow(adminCredentials = null) {
    return runFlow(
        ...
        async (results) => {
            ...
            // Step 1: Admin login
            results.push(await step('Admin login', async () => {
            ...
            results.push(await step('Get system stats', async () => {
            ...
            let allCompanies;
            results.push(await step('List all companies', async () => {
            ...
            results.push(await step('List pending companies', async () => {
            ...
            if (targetCompanyId) {
                ...
                let companyDetails;
                results.push(await step(`Get company details (ID: ${targetCompanyId})`, async () => {
                ...
                if (currentStatus === 'underReview') {
                    // Approve the company
                    results.push(await step('Approve company', async () => {
                    ...
                    results.push(await step('Update company status (demo)', async () => {
                    ...
                    results.push(await step(`Handle ${currentStatus} status`, async () => {
