...
export async function runDocumentsFlow(credentials = null) {
    return runFlow(
        ...
        async (results) => {
            ...
            let uploadedFile;
            results.push(await step('Upload document file', async () => {
            ...
            let createdDocument;
            results.push(await step('Create document record', async () => {
            ...
            results.push(await step('List documents', async () => {
            ...
            results.push(await step('Update document', async () => {
                const updateData = {
            ...
            results.push(await step('Delete document', async () => {
