...
const COMPANY_TYPES = [
    'supplier', 'manufacturer', 'distributor', 'retailer', 'serviceProvider',
    'wholesaler', 'eCommerce', 'franchise', 'cooperative', 'holdingCompany',
    'consultancy', 'logistics', 'other'
];
...
const EGYPTIAN_CITIES = [
    ...
    '6th of October', 'New Cairo', 'Zagazig', 'Damietta'
];
...
function generateContributionDetails(type) {
    switch (type) {
        ...
        case 'partnership':
            return {
                partnerType: faker.helpers.arrayElement(['strategic', 'distribution', 'technology', 'investment']),
...
export function generateTestDataSet(userCount = 2) {
    ...
    return {
        _comment: 'Auto-generated test data. Edit values as needed, especially email addresses for testing email flows.',
        users,
        companies,
        admin: {
